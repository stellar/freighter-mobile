...
export const HistoryScreen = () => {
  ...
  const handlePair = async () => {
    ...
    logger.debug("HistoryScreen", "pairing with URI", { uri });
  ...
  const handlePaste = async () => {
    try {
      ...
      logger.error("HistoryScreen", "error pasting from clipboard", err);
    }
  };

  const handleScan = (data: string) => {
    logger.debug("HistoryScreen", "QR code scanned", { data });
    setUri(data);
