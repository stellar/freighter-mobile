 ...
 * PRODUCTION !!! Shows the configured auto-lock timer and the live countdown
 * to the hash-key hard expiry so QA can watch the lock flows.
 * ===========================================================================
 */
...
import { getAutoLockTimer, getDevAutoLockTimerMs } from "services/autoLock";
...
export const AutoLockDevTimers: React.FC = () => {
  ...
  return (
    <View className="mt-1 items-center">
      <Text sm secondary>
        {`auto-lock (bg): ${formatSeconds(autoLockMs)}`}
      </Text>
      <Text sm secondary>
        {`hash expires in: ${
