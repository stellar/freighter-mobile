// Type-only, and mutual: `./historyV2BlendTypes` extends `V2StateChangeBase`
// from here. Both modules are pure type declarations, so both edges erase at
// compile time.
import type { V2BlendStateChange } from "config/historyV2BlendTypes";
