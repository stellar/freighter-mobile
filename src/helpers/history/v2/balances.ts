...
import { V2AccountTransaction, V2BalanceChange } from "config/historyV2Types";
...
export const mapBalanceChanges = (
  ...
  // eslint-disable-next-line @typescript-eslint/no-use-before-define -- ported verbatim; classify is defined below to keep mapBalanceChanges (the public entry point) first, matching the extension's file layout.
