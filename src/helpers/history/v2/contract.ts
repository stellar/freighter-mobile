...
import { V2Operation } from "config/historyV2Types";
import { ProtocolInfo } from "helpers/history/v2/model";
import { getArgsForTokenInvocation } from "helpers/soroban";
  ...
  try {
    ...
    switch (typed.type) {
      ...
      case "pathPaymentStrictReceive": {
        // eslint-disable-next-line prefer-destructuring -- ported verbatim from the extension; destructuring here would rename the copied line for no behavior change.
 ...
 */
// eslint-disable-next-line @typescript-eslint/no-unused-vars -- ported verbatim; the underscore-prefixed param is the intentional drop-in point for the future /protocols lookup (see doc comment above).
